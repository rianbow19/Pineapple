...
const COLLISION_POLYGONS = {
  ...
  "冠芽鳳梨.png": [
    206.11, 144.86, 404.86, 302.36, 554.86, 523.61, 584.86, 729.86, 532.36,
    936.11, 393.61, 1063.61, 191.11, 1101.11, -37.64, 1048.61, -146.39, 861.11,
    -157.64, 617.36, -71.39, 418.61, 22.36, 294.86,
  ],
  "組織培養的鳳梨.png": [
  ...
  "裔芽鳳梨.png": [
    347.25, 490.45, 452.25, 650.45, 542.25, 811.7, 568.5, 999.2, 516, 1202.95,
    390.11, 1332.86, 187.61, 1370.36, -24, 1296.7, -149.89, 1130.36, -129,
    880.45, -72.75, 702.95, 88.5, 522.9,
  ],
  "吸芽鳳梨.png": [
    399.5, 432.95, 324.5, 605.45, 418.25, 714.2, 467, 856.7, 500.75, 1029.2,
    440.75, 1242.95, 324.5, 1344.2, 148.25, 1381.7, -73, 1334.2, -198.89,
    1167.86, -178, 917.95, -84.25, 710.45, 39.5, 612.95, 167, 571.7, 163.25,
    387.95,
  ],
};
...
class Game {
  constructor() {
    ...
    this.mouseState = {
      ...
      MAX_PRESS_DURATION: 500, // 最大允許按下時間（毫秒）
    };
